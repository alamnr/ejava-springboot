package info.ejava.examples.svc.springdoc.contest.dto;
...
/*
 * This swagger model class example will express all fields with in this class file 
 * and not through any properties
 */

@Schema(description = "This class describes a contest between a home and away team, " + "either  in the past or future") 
public class ContestDTO {
     ...
     * property, it wants to create an instance of that property using the  annotation 
     * example field -- which is by default an empty string. For int and Integer that 
     * cause a parsing problem because the API spec generation wanted parse an integer from the example
     * 
     */
    ...
    private Instant getScheduledStartAsInstant(){
        return null == scheduledStart ? null : scheduledStart.toInstant();
    }
