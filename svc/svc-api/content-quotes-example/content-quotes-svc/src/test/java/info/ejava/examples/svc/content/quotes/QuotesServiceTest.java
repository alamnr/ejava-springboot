...
public class QuotesServiceTest {
    ...
    private QuoteDTOFactory quotesDtoFactory = new QuoteDTOFactory();
    ...
    public void add_quote_accepted() {
        // given - a valid quote
        QuoteDTO validQuote = quotesDtoFactory.make();
    ...
    @Test
    public void updating_existing_quote() {
        // given - an existing quote
        QuoteDTO existingQuote = quotesDtoFactory.make(QuoteDTOFactory.oneUpId);
        QuoteDTO updatedQuote = quotesDtoFactory.make();
    ...
    public void get_random_quote() {
        ...
        given(quoteMap.values()).willReturn(quotesDtoFactory.listBuilder().quotes(100, 100, QuoteDTOFactory.oneUpId));
    ...
    public void get_many_quotes() {
        // given many quotes
        given(quoteMap.size()).willReturn(100);
        List<QuoteDTO> quotes = quotesDtoFactory.listBuilder().quotes(100, 100, QuoteDTOFactory.oneUpId);
