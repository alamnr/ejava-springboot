...
@Slf4j
public class QuotesApiWebClient implements QuotesApi {
    
    private final URI baseUrl;
    private final WebClient webClient;
    private final MediaType mediaType;

    public QuotesApiWebClient(WebClient webClient,ServerConfig serverConfig, String mediaType){
        this.webClient = webClient;
        this.baseUrl = UriComponentsBuilder.fromUri(serverConfig.getBaseUrl()).build().toUri();
        this.mediaType = MediaType.valueOf(mediaType);
    }

    public QuotesApiWebClient(WebClient webClient, ServerConfig serverConfig){
