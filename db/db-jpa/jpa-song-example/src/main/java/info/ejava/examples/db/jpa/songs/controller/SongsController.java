...
public class SongsController {
    ...
    public ResponseEntity<SongDTO> createSong(@RequestBody SongDTO songDTO) {
        ...
        URI uri = ServletUriComponentsBuilder.fromCurrentRequestUri().replacePath(SONG_PATH).build(result.getId());
    ...
    @RequestMapping(path = SONG_PATH, method = RequestMethod.GET,
                    produces = {MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE})
    public ResponseEntity<SongDTO> getSong(@PathVariable(name = "id") int id){
    ...
    @RequestMapping(path = RANDOM_SONG_PATH, method = RequestMethod.GET,
                    produces = {MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE})
    ...
    @RequestMapping(path = SONG_PATH,method = RequestMethod.PUT,
                    consumes = {MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE})
    public ResponseEntity<Void> updateSong(@PathVariable("id") int id, @RequestBody SongDTO songDTO) {
    ...
    @RequestMapping(path = SONG_PATH, method = RequestMethod.DELETE)
    ...
    @RequestMapping(path = SONGS_PATH, method = RequestMethod.DELETE)
